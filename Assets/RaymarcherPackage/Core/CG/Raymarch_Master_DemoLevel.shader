Shader "Matej Vanco/RayMarcher/PC/RM Master_DemoLevel"
{
	...
	SubShader
	{
		...
		Pass
		{
			CGPROGRAM
				...
				#include "ShapeSources\Raymarch_ShapesSource_DemoLevel.cginc"

				#include "Includes\PC\Raymarch_FractsSource.cginc"

				#include "ObjectBuffers\Raymarch_ObjectBuffer_DemoLevel.cginc"	
